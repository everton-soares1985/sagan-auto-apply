...
FIELD_CATEGORIES = {
    ...
    "resume_text":       ["paste.*resume", "copy.*resume", "resume text", "unstructured text", "paste your cv"],
    ...
    "current_salary":    ["current salary", "current compensation", "base salary", "current base"],
    "target_salary":     ["salary expectation", "desired salary", "expected salary", "target salary"],
